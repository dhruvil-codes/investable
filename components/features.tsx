...
export function Features() {
    return (
        <section id="features" className="bg-canvas text-ink py-16 md:py-32 border-b border-hairline relative overflow-hidden">
            {/* Subtle glow background details */}
            <div className="absolute top-0 left-1/4 w-[400px] h-[400px] bg-brand-indigo/5 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-brand-lavender/5 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6 relative z-10">
                ...
                >
                    <span className="text-xs font-semibold text-brand-indigo uppercase tracking-widest bg-brand-indigo/10 px-3 py-1 rounded-full">
                        INSIDE THE REVIEW
                    </span>
                    <h2 className="font-display text-4xl md:text-5xl font-normal tracking-tight text-slate-900 max-w-2xl leading-tight">
                        Why pitch VCs without knowing their <span className="italic font-light text-brand-indigo">real objections?</span>
                    </h2>
                    <p className="text-base md:text-lg text-slate-500 font-sans max-w-lg">
                        We simulate the entire committee feedback loop so you can fix major flaws before pitching actual investors.
                    </p>
                </motion.div>

                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        {/* CARD 1: 41 VCs on the panel */}
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <Card className="relative flex overflow-hidden bg-white border border-hairline text-slate-900 min-h-[220px] shadow-xs h-full">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center justify-center">
                                    <svg className="text-brand-indigo/5 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold font-sans tracking-tight relative z-10 text-slate-900">
                                        <CountUp to={41} /> VCs
                                    </span>
                                </div>
                                <h2 className="mt-6 text-center text-lg font-medium text-slate-500">on the panel</h2>
                            </CardContent>
                        </Card>
                        </motion.div>

                        {/* CARD 2: VC Panel Review */}
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, margin: "-80px" }}
                        ...
                        >
                            <Card className="relative overflow-hidden bg-white border border-hairline text-slate-900 shadow-xs h-full">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-slate-200/60 before:absolute before:-inset-2 before:rounded-full before:border before:border-slate-100 items-center justify-center">
                                    <div className="relative size-full flex items-center justify-center overflow-visible">
                                        {/* Slanted Retro Verdict Stamps */}
                                        <div className="absolute transform -rotate-12 -translate-x-5 -translate-y-4 border-2 border-red-500/80 text-red-500 font-mono font-bold text-[10px] px-1.5 py-0.5 rounded bg-white tracking-widest uppercase shadow-sm select-none">
                                            PASS
                                        </div>
                                        <div className="absolute transform rotate-12 translate-x-5 translate-y-3 border-2 border-emerald-500/80 text-emerald-500 font-mono font-bold text-[10px] px-1.5 py-0.5 rounded bg-white tracking-widest uppercase shadow-sm select-none">
                                            INVEST
                                        </div>
                                        <div className="absolute transform -rotate-6 translate-y-9 -translate-x-1 border-2 border-amber-500/80 text-amber-500 font-mono font-bold text-[9px] px-1.5 py-0.5 rounded bg-white tracking-wide uppercase shadow-sm select-none">
                                            STRONGLY CONSIDER
                                        </div>
                                    </div>
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-slate-900 transition">VC Panel Review</h2>
                                    <p className="text-slate-500 text-xs leading-relaxed">
                                        A detailed simulation of 5 archetype partners arguing over your deck behind closed doors. Experience the raw skepticism firsthand.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        >
                            ...
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    ...
                                    <svg className="text-slate-400 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            <circle className="text-slate-100" cx="29" cy="29" r="15" fill="currentColor" />
                                            <path d="M29 23V35" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-500" />
                                            <path d="M35 29L29 35L23 29" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-500" />
                                            <path
                                        ...
                                        />
                                        <path
                                            className="text-brand-indigo/80"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-brand-indigo/20" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-slate-900 transition">Granular Scorecard</h2>
                                    <p className="text-slate-500 text-xs leading-relaxed">
                                        Specific ratings on TAM, product viability, unit economics, and team credibility. Know exactly which slide triggered the pass.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        {/* CARD 4: Investment Committee Debate */}
                        <motion.div
                            initial={{ opacity: 0, y: 30 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true, margin: "-80px" }}
                        ...
                        >
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-slate-200 bg-slate-50 items-center justify-center">
                                        <Scale className="m-auto size-5 text-slate-700" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-slate-900 transition">Bull vs Bear. Live.</h2>
                                        <p className="text-slate-500 text-xs leading-relaxed">
                                            Hear the actual partner debate — who wants to invest, who's skeptical, and what question they'd ask you in the room.
                                        </p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-slate-200/80 p-6 py-6 sm:ml-6 bg-slate-50/50">
                        ...
                        >
                            ...
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-slate-200 bg-slate-50 items-center justify-center">
                                        <Gavel className="m-auto size-5 text-slate-700" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-slate-900 transition">Fundability Verdict</h2>
                                        <p className="text-slate-500 text-xs leading-relaxed">
                                            An upfront Yes/No decision paired with an aggressive, actionable checklist of red flags you must fix to build real investor trust.
                                        </p>
                                    </div>
                                </div>
                                {/* Stacked Checklist Layout */}
                                <div className="before:bg-slate-200 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6 flex flex-col justify-center">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6 overflow-visible">
                                        {/* Verdict Header stamp */}
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded-full border border-red-500/30 bg-red-500/10 text-red-500 font-mono font-bold text-[9px] tracking-wide px-2 py-0.5 shadow-sm">
                                                VERDICT: PASS (HARD PASS)
                                            </span>
                                            <div className="ring-white size-7 ring-4 rounded-full bg-red-500 flex items-center justify-center text-white text-[11px] font-black shrink-0 shadow-md">
                                                !
                                            </div>
                                        </div>
                                        {/* Red flag line 1 */}
                                        <div className="relative ml-[calc(50%-0.875rem)] flex items-center gap-2 pr-4">
                                            <div className="ring-white size-7 ring-4 rounded-full bg-amber-500 flex items-center justify-center text-white shrink-0 shadow-md">
                                                <svg className="size-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                                </svg>
                                            </div>
                                            <span className="block h-fit rounded border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] text-slate-700 shadow-sm leading-normal max-w-[160px] sm:max-w-[200px]">
                                                CAC calculation excludes founder sales efforts.
                                            </span>
                                        </div>
                                        {/* Red flag line 2 */}
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] text-slate-700 shadow-sm leading-normal text-right max-w-[160px] sm:max-w-[200px]">
                                                Solo founder without a technical co-founder.
                                            </span>
                                            <div className="ring-white size-7 ring-4 rounded-full bg-amber-500 flex items-center justify-center text-white shrink-0 shadow-md">
                                                <svg className="size-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
